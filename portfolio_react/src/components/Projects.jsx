                ...
                <div className="d-flex flex-column">
                    ...
                    <div className="pt-3">
                        <Project 
                            ...
                            contentTitle="SPA 게시판" contentDescription="" contentLink=""
                        />
                    ...
                    <div className="pt-3">
                        <Project
                            ...
                            contentTitle="" contentDescription="" contentLink=""
                        />
    ...
    return (
        <div className="pt-3">
            ...
            <div className="d-flex flex-wrap py-2">
                ...
                <ContentBox title={contentTitle} description={contentDescription} link={contentLink}/>
            </div>
        </div>
    )
}